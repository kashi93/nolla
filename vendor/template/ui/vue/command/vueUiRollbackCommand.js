...
var VueUiRollbackCommand = /** @class */ (function () {
    function VueUiRollbackCommand() {
    }
    VueUiRollbackCommand.prototype.handle = function () {
    ...
    VueUiRollbackCommand.prototype.app = function () {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
    ...
    VueUiRollbackCommand.prototype.pack = function () {
        var e_1, _a, e_2, _b;
        return __awaiter(this, void 0, void 0, function () {
    ...
    VueUiRollbackCommand.prototype.nodeModules = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    VueUiRollbackCommand.prototype.webpack = function () {
        return __awaiter(this, void 0, void 0, function () {
            var app;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    VueUiRollbackCommand.prototype.js = function () {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!fs_1.default.existsSync("".concat(path_1.default.dirname((_a = require.main) === null || _a === void 0 ? void 0 : _a.filename), "/resources/js/vue"))) return [3 /*break*/, 2];
                        return [4 /*yield*/, fs_1.default.promises.rm("".concat(path_1.default.dirname((_b = require.main) === null || _b === void 0 ? void 0 : _b.filename), "/resources/js/vue"), { recursive: true })];
                    case 1:
                        _c.sent();
                        return [2 /*return*/, true];
                    case 2: return [2 /*return*/, false];
    ...
    return VueUiRollbackCommand;
}());
exports.default = new VueUiRollbackCommand();
